...
const TableTennisScheduler = () => {
  ...
  const fetchMatches = async () => {
    setLoading(true);
    try {
      const response = await axios.get("https://project-v1-2-1.onrender.com/api/matches");
  ...
  const startTournament = async () => {
    setLoading(true);
    try {
      await axios.post("https://project-v1-2-1.onrender.com/api/matches/schedule");
  ...
  const advanceToNextRound = async () => {
    ...
    try {
      const response = await axios.post(
        "https://project-v1-2-1.onrender.com/api/matches/next-round"
      );
  ...
  const resetTournament = async () => {
    setLoading(true);
    try {
      await axios.delete("https://project-v1-2-1.onrender.com/api/matches/reset");
      setMatches([]);
      setCurrentRound(0);
      setTournamentWinner(null);
      setError("");
